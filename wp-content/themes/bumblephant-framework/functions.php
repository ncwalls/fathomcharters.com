...
class MakespaceFramework {
	...
	function admin_menu(){
		...
		acf_add_options_page( array(
			...
			'menu_title' => 'Theme',
			// 'icon_url' => get_template_directory_uri() . '/fathom_logo-white.png',
			...
			'redirect' => false,
			'menu_slug' => 'theme-framework-options',
			'autoload' => true
		) );
	...
	function check_required_plugins(){
		...
		if( !is_plugin_active( 'advanced-custom-fields-pro/acf.php' ) ){
			...
			add_action( 'admin_notices', function(){
				echo '<div class="notice notice-info is-dismissible"><p><strong>Advanced Custom Fields PRO</strong> is a required plugin for the theme and has been automatically activated.</p></div>';
			} );
		}
	}
